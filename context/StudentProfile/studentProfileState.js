...
const studentProfileState = (props) => {
  ...
  return (
    <StudentProfileContext.Provider value={{ getStudent, userProfile, getProfilePicture, addLanguage, addProfilePic, addBio, languages, addEducation, educations, addInterest, deleteInterest, deleteEducation, deleteLanguage, editInterest, editLanguage, editEducation }}>
      {props.children}
