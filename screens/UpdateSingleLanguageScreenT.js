...
const UpdateSingleLanguageScreenT = ({ route }) => {
    ...
    <ScrollView style={{ flex: 1, flexDirection: flexD, backgroundColor: "#adadad" }}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <TextInput defaultValue={languageName} placeholderTextColor="black" value={languageName} onChangeText={(text) => setLanguageName(text)} style = {styles.input}/>
        </View>
        <View style={styles.sectionContainer}>
...
export default UpdateSingleLanguageScreenT;