      ...
      <View style={styles.sectionContainer}>
        <View style={styles.sectionIconsContainer}>
          ...
          {worth && (
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddEducationScreenT")}>
              <Image
                style={styles.icon}
                resizeMode="cover"
        ...
        {additionalData.map((education, index) => (
          <View key={index}>
...
export default ViewAllEducationT;