  ...
  return (
    <View style={styles.container}>
      <ScrollView style={{ flex: 1, flexDirection: flexD, backgroundColor: "#adadad", marginTop: "50%" }}>
        ...
        />
        <Text style={styles.heading}>TALENT MATCH</Text>
        <Text style={styles.description}>
        Smooth platform to connect students with expert teachers by enabling topic requests, teacher bids, and seamless hiring.
        </Text>
