      ...
      <View style={styles.sectionContainer}>
        <View style={styles.sectionIconsContainer}>
          ...
          {worth && (
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddLanguageScreenT")}>
              <Image
                style={styles.icon}
                resizeMode="cover"
        ...
        {additionalData.map((language, index) => (
          <View key={index}>
...
export default ViewAllLanguagesT;