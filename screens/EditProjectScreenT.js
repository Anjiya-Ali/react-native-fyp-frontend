...
const EditProjectScreenT = ({ route }) => {
  ...
  const handleDelete = async () => {
    await deleteProject(requestId);
    setLocalProjects(localProjects.filter((project) => project.id !== requestId));
    setShowRejectModal(false);
  };

  const handleUpdateProject = async (title, description, start_date, end_date, link, id) => {
    navigation.navigate("UpdateSingleProjectScreenT", {
      additionalData: { title, description, start_date, end_date, link, id },
    })
  };
    ...
    >
      ...
      <View style={styles.sectionContainer}>
        <View style={styles.sectionIconsContainer}>
          <Text style={styles.sectionTitle}>Edit Projects</Text>
        </View>
        {localProjects.map((project, index) => (
          <View key={index}>
            ...
            <View style={styles.sectionIconsContainer}>
              <TouchableOpacity onPress={() => handleUpdateProject(project.title, project.description, project.start_date, project.end_date, project.link, project.id)}>
                <Image
                  style={styles.icon}
                  resizeMode="cover"
...
export default EditProjectScreenT;
