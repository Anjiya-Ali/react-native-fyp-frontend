      ...
      <View style={styles.sectionContainer}>
        <View style={styles.sectionIconsContainer}>
          ...
          {worth && (
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddProjectScreenT")}>
              <Image
                style={styles.icon}
                resizeMode="cover"
        ...
        {additionalData.map((project, index) => (
          <View key={index}>
...
export default ViewAllProjectsT;