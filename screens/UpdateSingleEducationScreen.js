...
const UpdateSingleEducationScreen = ({ route }) => {
    ...
    <ScrollView style={{ flex: 1, flexDirection: flexD, backgroundColor: "#d9d9d9" }}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <TextInput style={styles.input} placeholderTextColor="black" value={educationSchool} onChangeText={(text) => setEducationSchool(text)} multiline={true}/>
        </View>
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionTitle}>Degree</Text>
          <TextInput style={styles.input} placeholderTextColor="black" value={educationDegree} onChangeText={(text) => setEducationDegree(text)} multiline={true}/>
        </View>
        <View style={styles.sectionContainer}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <TextInput style={styles.input} placeholderTextColor="black" value={educationGrade} onChangeText={(text) => setEducationGrade(text)} multiline={true}/>
        </View>
        <TouchableOpacity
...
export default UpdateSingleEducationScreen;